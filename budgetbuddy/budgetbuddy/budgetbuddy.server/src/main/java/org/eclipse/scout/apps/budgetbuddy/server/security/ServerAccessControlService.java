package org.eclipse.scout.apps.budgetbuddy.server.security;

import org.eclipse.scout.apps.budgetbuddy.shared.security.AccessControlService;
...
public class ServerAccessControlService extends AccessControlService {
  ...
  protected IPermissionCollection execLoadPermissions(String userId) {
    ...
    //TODO [Dino]: Fill access control service - or replace this default implementation by simply return BEANS.get(AllPermissionCollection.class)
